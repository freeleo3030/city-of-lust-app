...
export default function CreatorDashboardPage({ chars, onAdd, onEdit, onDelete, onBack, onUpdateChar }: Props) {
  ...
  const S: Record<string, React.CSSProperties> = {
    ...
    tab: { flex: 1, background: 'rgba(255,255,255,0.05)', border: '1px solid #ffffff22', borderRadius: s(8), color: '#ffffff66', padding: s(8), cursor: 'pointer', fontSize: s(13) },
    tabActive: { background: 'rgba(201,168,76,0.15)', border: '1px solid #c9a84c66', color: '#c9a84c' },
    imgGrid: { display: 'grid', gridTemplateColumns: `repeat(auto-fill, minmax(${s(120)}px, 1fr))`, gap: s(10) },
