...
export default function FemaleCharacterCreatePage({
  ...
  const S: Record<string, React.CSSProperties> = {
    ...
    card: { background: 'rgba(255,255,255,0.05)', border: '1px solid #c9a84c22', borderRadius: s(16), padding: `${s(20)}px`, display: 'flex', flexDirection: 'column', gap: s(12) },
    ...
    input: { background: 'rgba(255,255,255,0.08)', border: '1px solid #ffffff22', borderRadius: s(8), padding: `${s(8)}px ${s(12)}px`, color: '#fff', fontSize: s(14), outline: 'none', flex: 1, minWidth: 0 },
    textarea: { background: 'rgba(255,255,255,0.08)', border: '1px solid #ffffff22', borderRadius: s(8), padding: `${s(8)}px ${s(12)}px`, color: '#fff', fontSize: s(13), outline: 'none', flex: 1, resize: 'none', fontFamily: 'inherit' },
    select: { background: 'rgba(255,255,255,0.08)', border: '1px solid #ffffff22', borderRadius: s(8), padding: `${s(8)}px ${s(12)}px`, color: '#fff', fontSize: s(14), outline: 'none', flex: 1 },
    chips: { display: 'flex', gap: s(8), flexWrap: 'wrap' },
    chip: { background: 'rgba(255,255,255,0.06)', border: '1px solid #ffffff22', borderRadius: s(20), padding: `${s(5)}px ${s(14)}px`, color: '#ffffff66', fontSize: s(13), cursor: 'pointer' },
    ...
    tag: { background: 'rgba(255,255,255,0.06)', border: '1px solid #ffffff22', borderRadius: s(20), padding: `${s(4)}px ${s(12)}px`, color: '#ffffff66', fontSize: s(12), cursor: 'pointer' },
    ...
    hiddenBadge: { background: 'rgba(233,69,96,0.2)', border: '1px solid #e9456055', borderRadius: s(20), padding: `${s(2)}px ${s(10)}px`, color: '#e94560', fontSize: s(11), marginLeft: s(8) },
    ...
    completeBtn: { background: 'linear-gradient(135deg, #c9a84c, #e94560)', border: 'none', borderRadius: s(12), padding: `${s(16)}px`, color: '#fff', fontWeight: 'bold', fontSize: s(16), cursor: 'pointer', marginTop: s(8) },
